package dev.gaphunter.idempotencykeycompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.idempotencykeycompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.idempotencykeycompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Idempotency Key Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33788-idempotency-key-companion/reviews"
